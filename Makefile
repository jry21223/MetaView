...
.PHONY: bootstrap bootstrap-manim setup-hooks dev-web dev-api dev-agent dev start stop lint test test-coverage build check docker-build docker-up docker-down eval eval-shots eval-generate
